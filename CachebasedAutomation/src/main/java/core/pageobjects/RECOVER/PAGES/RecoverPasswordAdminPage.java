...
public class RecoverPasswordAdminPage extends AbsRecoverPasswordPage {
     ...
     */
    public RecoverPasswordAdminPage(WebDriver driver) {
        super(driver);
        initElements();
    }
    ...
    public void initElements() {
        ...
        try {
            ...
            this.twoFacAuthMsgCached = waitUntilElementPresence(
                    AWMapper.getData("ADMIN", "RECOVER_PAGE_2FA_MSG"));
            this.okBtnCached = waitUntilElementPresence(
                    AWMapper.getData("ADMIN", "RECOVER_PAGE_OK_BTN"));
        }
        catch (Exception e) {
